...
func TestBasicsFlowTypes(t *testing.T) {
	// expectPrintedFlow(t,
	...
	expectPrintedFlow(t,
		"import { type TypeModule, implementationModule } from \"module\"\n",
		"import { implementationModule } from \"module\";\n")
	expectPrintedFlow(t,
		"import { typeof TypeModule, implementationModule } from \"module\"\n",
		"import { implementationModule } from \"module\";\n")
	expectPrintedFlow(t,
		"type Object = {| name: string, ...AnotherObject |}",
		"")
	expectPrintedFlow(t,
		"export const sum = (a: number, b: (value: string) => number): number => a + b\n",
		"export const sum = (a, b) => a + b;\n")
	expectPrintedFlow(t,
		"export const sum = (input: string, fn: (value: string) => mixed): ?number => 4\n",
		"export const sum = (input, fn) => 4;\n")
}
...
func TestBabelFlowTypes(t *testing.T) {
	...
	// 	expectPrintedFlow(t, "var {x}: {x: string } = { x: \"hello\" };", "var {\n  x\n} = {\n  x: \"hello\"\n};\n")
	// 	expectPrintedFlow(t, "var [x]: Array<string> = [ \"hello\" ];", "var [x] = [\"hello\"];\n")
	// 	expectPrintedFlow(t, "var {x}: {x: string; } = { x: \"hello\" };", "var {\n  x\n} = {\n  x: \"hello\"\n};\n")
	// 	expectPrintedFlow(t, "function foo({x}: { x: string; }) {}", "function foo({\n  x\n}) {\n}\n")
...
func TestFlowTypes(t *testing.T) {
	...
	// exact_objects
	expectPrintedFlow(t, "var obj: { x: number, y: string }\n", "var obj;\n")
	...
	expectPrintedFlow(t, "type ExactObject = {||}\n", "")
	...
	// expectPrintedTS(t, "declare function foo(x: number, string): void\n", "")
	// expectPrintedTS(t, "declare class A {}\n", "")
	// expectPrintedTS(t, "declare class A<T> extends B<T> { x: number }\n", "")
	// expectPrintedTS(t, "declare class A { static foo(): number; static x : string; }\n", "")
	// expectPrintedTS(t, "declare class A { static () : number }\n", "")
	// expectPrintedTS(t, "declare class A { static [ indexer: number]: string }\n", "")
	// expectPrintedTS(t, "declare class A { get foo(): number; }\n", "")
	// expectPrintedTS(t, "declare class A { set foo(x: number): void; }\n", "")
	// expectPrintedTS(t, "declare class A { get foo(): number; set foo(x: string): void; }\n", "")

	// // function_predicates
	// expectPrintedTS(t, "declare function f(x: mixed): boolean %checks(x !== null);\n", "")
	// expectPrintedTS(t, "declare function f(x: mixed): boolean %checks(x !== null)\n", "")
	// expectPrintedTS(t, "function foo(x: mixed): %checks { return x !== null }\n", "function foo(x) {\n  return x !== null;\n}\n")
	// expectPrintedTS(t, "var a1 = (x: mixed): %checks => x !== null;\n", "var a1 = (x) => x !== null;\n")
	// expectPrintedTS(t, "(x): %checks => x !== null;\n", "(x) => x !== null;\n")

	// // grouping
	// expectPrintedTS(t, "type A = (B) => (C)\n", "")
	// expectPrintedTS(t, "type A = (b: (B)) => C\n", "")
	// expectPrintedTS(t, "type A = B & (C)\n", "")
	// expectPrintedTS(t, "var a: number & (string | bool)\n", "var a;\n")
	// expectPrintedTS(t, "type A = {\n  b(): (B)\n}\n", "")
	// expectPrintedTS(t, "var a: (number)\n", "var a;\n")
	// expectPrintedTS(t, "var a: (() => number) | () => string\n", "var a;\n")
	// expectPrintedTS(t, "var a: (typeof A)\n", "var a;\n")
	// expectPrintedTS(t, "var a: Array<(number)>\n", "var a;\n")
	// expectPrintedTS(t, "var a: ([]) = []\n", "var a = [];\n")
	// expectPrintedTS(t, "var a: (number: number) => number = (number) => { return 123; }\n", "var a = (number) => {\n  return 123;\n};\n")
	// expectPrintedTS(t, "type A = ?(?B)\n", "")
	// expectPrintedTS(t, "type A = {\n  (): (B)\n}\n", "")
	// expectPrintedTS(t, "type A = {\n  [B]: (C)\n}\n", "")
	// expectPrintedTS(t, "type A = {\n  b: (B)\n}\n", "")
	// expectPrintedTS(t, "type A = {\n  ...(B)\n}\n", "")
	// expectPrintedTS(t, "type A = typeof (B)\n", "")
	// expectPrintedTS(t, "type A = B | (C)\n", "")

	// // import_types
	// // ok, because `switch` is not a reserved type name
	// expectPrintedTS(t, "import type switch from 'foo';\n", "")
	// // ok, reserved words are not reserved types
	// expectPrintedTS(t, "import type { switch } from 'foo';\n", "")
	// // ok, `string` is a reserved type but it's renamed
	// expectPrintedTS(t, "import typeof { string as StringT } from 'foo';\n", "")

	// // import_type_shorthand
	// expectPrintedTS(t, "import {type} from \"foo\";\n", "import {type} from \"foo\";\n")
	// expectPrintedTS(t, "import {type t} from \"foo\";\n", "")
	// expectPrintedTS(t, "import {type as} from \"foo\";\n", "")
	// expectPrintedTS(t, "import {type t as u} from \"foo\";\n", "")
	// expectPrintedTS(t, "import {typeof t} from \"foo\";\n", "")
	// expectPrintedTS(t, "import {typeof as} from \"foo\";\n", "")
	// expectPrintedTS(t, "import {typeof t as u} from \"foo\";\n", "")
	// // ok, a type named `as`, renamed to `x`
	// expectPrintedTS(t, "import { type as as x } from \"ModuleName\";\n", "")
	// // ok, `switch` is a reserved value but not reserved type name
	// expectPrintedTS(t, "import { typeof switch } from \"foo\";\n", "")

	// // function_types_with_anonymous_parameters
	// expectPrintedTS(t, "type T = Array<(string) => number>\n", "")
	// expectPrintedTS(t, "let x = (): Array<(string) => number> => []\n", "let x = () => [];\n")
	// expectPrintedTS(t, "type A = (string) => void\n", "")
	// expectPrintedTS(t, "type A = (string,) => void\n", "")
	// expectPrintedTS(t, "type A = (Array<string>) => void\n", "")
	// expectPrintedTS(t, "type A = (Array<string>,) => void\n", "")
	// expectPrintedTS(t, "type A = (x: string, number) => void\n", "")
	// expectPrintedTS(t, "type A = (...Array<string>) => void\n", "")
	// expectPrintedTS(t, "type A = (Array<string>, ...Array<string>) => void\n", "")
	// // Non-anonymous function types are allowed as arrow function return types
	// expectPrintedTS(t, "var f = (x): (x: number) => 123 => 123;\n", "var f = (x) => 123;\n")
	// // Anonymous function types are disallowed as arrow function return types
	// // So the `=>` clearly belongs to the arrow function
	// expectPrintedTS(t, "var f = (): (number) => 123;\n", "var f = () => 123;\n")
	// expectPrintedTS(t, "var f = (): string | (number) => 123;\n", "var f = () => 123;\n")
	// // You can write anonymous function types as arrow function return types
	// // if you wrap them in parens
	// expectPrintedTS(t, "var f = (x): ((number) => 123) => 123;\n", "var f = (x) => 123;\n")
	// expectPrintedTS(t, "type A = string => void\n", "")
	// expectPrintedTS(t, "type A = Array<string> => void\n", "")
	// // Anonymous function types are disallowed as arrow function return types
	// // So the `=>` clearly belongs to the arrow function
	...
	// expectPrintedTS(t, "type A = string | number => boolean;\n", "")
	// // string & (number => boolean)
	// expectPrintedTS(t, "type A = string & number => boolean;\n", "")
	// // (?number) => boolean
	// expectPrintedTS(t, "type A = ?number => boolean;\n", "")
	// // (number[]) => boolean
	// expectPrintedTS(t, "type A = number[] => boolean;\n", "")
	// expectPrintedTS(t, "type A = (string => boolean) => number\n", "")
	// // string => (boolean | number)
	// expectPrintedTS(t, "type A = string => boolean | number;\n", "")
	// // Becomes string => (boolean => number)
	// expectPrintedTS(t, "type A = string => boolean => number;\n", "")
	// expectPrintedTS(t, "type T = (arg: string, number) => void\n", "")

	// // member
	// expectPrintedTS(t, "var a : A.B\n", "var a;\n")
	// expectPrintedTS(t, "var a : A.B.C\n", "var a;\n")
	// expectPrintedTS(t, "var a : A.B<T>\n", "var a;\n")
	// expectPrintedTS(t, "var a : typeof A.B<T>\n", "var a;\n")
	// expectPrintedTS(t, "var a: function.switch\n", "var a;\n")

	// // keyword_variable_collision
	// expectPrintedTS(t, "type arguments = string\n", "")
	// expectPrintedTS(t, "\"use strict\";\ntype arguments = string\n", "\"use strict\";\n")
	// expectPrintedTS(t, "type eval = string\n", "")
	// expectPrintedTS(t, "\"use strict\";\ntype eval = string\n", "\"use strict\";\n")
	// expectPrintedTS(t, "opaque type opaque = number;\nopaque type not_transparent = opaque;\n", "")
	// expectPrintedTS(t, "var opaque = 0;\nopaque += 4;\n", "var opaque = 0;\nopaque += 4;\n")
	// expectPrintedTS(t, "opaque(0);\n", "opaque(0);\n")

	// // interfaces
	// // ok, `implements` refers to types so reserved values are fine
	// expectPrintedTS(t, "class Foo implements switch {}\n", "class Foo {\n}\n")
	// expectPrintedTS(t, "interface A {}\n", "")
	// expectPrintedTS(t, "interface A<T, S> {}\n", "")
	// expectPrintedTS(t, "interface A { foo: number; }\n", "")
	// expectPrintedTS(t, "interface A extends B {}\n", "")
	// expectPrintedTS(t, "interface A extends B, C {}\n", "")
	// expectPrintedTS(t, "interface A<T> extends B<T> {}\n", "")
	// expectPrintedTS(t, "class Foo implements Bar {}\n", "class Foo {\n}\n")
	// expectPrintedTS(t, "class Foo extends Bar implements Bat, Man<number> {}\n", "class Foo extends Bar {\n}\n")
	// expectPrintedTS(t, "class Foo extends class Bar implements Bat {} {}\n", "class Foo extends class Bar {\n} {\n}\n")
	// expectPrintedTS(t, "class Foo extends class Bar implements Bat {} implements Man {}\n", "class Foo extends class Bar {\n} {\n}\n")
	// expectPrintedTS(t, "interface A {numVal: number; [index: number]: string};\n", ";\n")
	// expectPrintedTS(t, "interface A {[index: number]: string; [index2: string]: number};\n", ";\n")
	// // OK: static is a valid identifier name
	// expectPrintedTS(t, "interface A { static: number }\ninterface B { static?: number }\ninterface C { static(): void } // method named static\ninterface D { static<X>(x: X): X } // poly method named static\n", "")
	// // ok, reserved values can be valid types
	// expectPrintedTS(t, "interface switch {}\n", "")

	// // number_literal
	// expectPrintedTS(t, "var a: 123\n", "var a;\n")
	// expectPrintedTS(t, "var a: 123.0\n", "var a;\n")
	// expectPrintedTS(t, "var a: 0x7B\n", "var a;\n")
	// expectPrintedTS(t, "var a: 0b1111011\n", "var a;\n")
	// expectPrintedTS(t, "var a: 0o173\n", "var a;\n")
	// expectPrintedTS(t, "var a: -123\n", "var a;\n")
	// expectPrintedTS(t, "var a: - 123\n", "var a;\n")
	// expectPrintedTS(t, "var a: 25257156155\n", "var a;\n")
	// expectPrintedTS(t, "var a: 0x5E1719E3B\n", "var a;\n")
	// expectPrintedTS(t, "var a: 0o274134317073\n", "var a;\n")
	// expectPrintedTS(t, "var a: 1e5\n", "var a;\n")

	// // object_type_spread
	// expectPrintedTS(t, "type T = {...O}\n", "")
	// expectPrintedTS(t, "type T = {...O,}\n", "")
	// expectPrintedTS(t, "type T = {p:T, ...O}\n", "")
	// expectPrintedTS(t, "type T = {...O, p:T}\n", "")
	// expectPrintedTS(t, "type T = {...O1, ...O2}\n", "")

	// // optional_indexer_name
	// expectPrintedTS(t, "type A = { [string]: number };\n", "")
	// expectPrintedTS(t, "type A = { [string | boolean]: number };\n", "")

	// // object_type_property_variance
	// expectPrintedTS(t, "type X = {p:T}\n", "")
	// expectPrintedTS(t, "type X = {+p:T}\n", "")
	// expectPrintedTS(t, "type X = {-p:T}\n", "")
	// expectPrintedTS(t, "type X = {m():T}\n", "")
	// expectPrintedTS(t, "type X = {[k:K]:V}\n", "")
	// expectPrintedTS(t, "type X = {+[k:K]:V}\n", "")
	// expectPrintedTS(t, "type X = {-[k:K]:V}\n", "")
	// expectPrintedTS(t, "type X = {():T}\n", "")

	// // string_literal
	// expectPrintedTS(t, "var a: \"duck\"\n", "var a;\n")
	// expectPrintedTS(t, "var a: 'duck'\n", "var a;\n")
	// expectPrintedTS(t, "var a: \"foo bar\"\n", "var a;\n")

	// // tuples
	// expectPrintedTS(t, "var a : [] = [];\n", "var a = [];\n")
	// expectPrintedTS(t, "var a : [Foo<T>] = [foo];\n", "var a = [foo];\n")
	// expectPrintedTS(t, "var a : [number,] = [123,];\n", "var a = [123];\n")
	// expectPrintedTS(t, "var a : [number, string] = [123, \"duck\"];\n", "var a = [123, \"duck\"];\n")

	// // typecasts
	// expectPrintedTS(t, "(xxx: number)\n", "xxx;\n")
	// expectPrintedTS(t, "({xxx: 0, yyy: \"hey\"}: {xxx: number; yyy: string})\n", "({\n  xxx: 0,\n  yyy: \"hey\"\n});\n")
	// // distinguish between function type params and typecasts
	// expectPrintedTS(t, "((xxx) => xxx + 1: (xxx: number) => number)\n", "(xxx) => xxx + 1;\n")
	// // parens disambiguate groups from casts
	// expectPrintedTS(t, "((xxx: number), (yyy: string))\n", "xxx, yyy;\n")

	// // parameter_defaults
	// expectPrintedTS(t, "type A<T = string> = T\n", "")
	// expectPrintedTS(t, "type A<T: ?string = string> = T\n", "")
	// expectPrintedTS(t, "type A<S, T: ?string = string> = T\n", "")
	// expectPrintedTS(t, "type A<S = number, T: ?string = string> = T\n", "")
	// expectPrintedTS(t, "class A<T = string> {}\n", "class A {\n}\n")
	// expectPrintedTS(t, "class A<T: ?string = string> {}\n", "class A {\n}\n")
	// expectPrintedTS(t, "class A<S, T: ?string = string> {}\n", "class A {\n}\n")
	// expectPrintedTS(t, "class A<S = number, T: ?string = string> {}\n", "class A {\n}\n")
	// expectPrintedTS(t, "(class A<T = string> {})\n", "(class A {\n});\n")
	// expectPrintedTS(t, "(class A<T: ?string = string> {})\n", "(class A {\n});\n")
	// expectPrintedTS(t, "(class A<S, T: ?string = string> {})\n", "(class A {\n});\n")
	// expectPrintedTS(t, "(class A<S = number, T: ?string = string> {})\n", "(class A {\n});\n")
	// expectPrintedTS(t, "declare class A<T = string> {}\n", "")
	// expectPrintedTS(t, "declare class A<T: ?string = string> {}\n", "")
	// expectPrintedTS(t, "declare class A<S, T: ?string = string> {}\n", "")
	// expectPrintedTS(t, "declare class A<S = number, T: ?string = string> {}\n", "")
	// expectPrintedTS(t, "interface A<T = string> {}\n", "")
	// expectPrintedTS(t, "interface A<T: ?string = string> {}\n", "")
	// expectPrintedTS(t, "interface A<S, T: ?string = string> {}\n", "")
	// expectPrintedTS(t, "interface A<S = number, T: ?string = string> {}\n", "")
	// expectPrintedTS(t, "var x: Foo<>\n", "var x;\n")
	// expectPrintedTS(t, "class A extends B<> {}\n", "class A extends B {\n}\n")
	// expectPrintedTS(t, "function foo<T = string>() {}\n", "function foo() {\n}\n")
	// expectPrintedTS(t, "({ foo<T = string>() {} })\n", "({foo() {\n}});\n")
	// expectPrintedTS(t, "class A { foo<T = string>() {} }\n", "class A {\n  foo() {\n  }\n}\n")
	// expectPrintedTS(t, "(class A { foo<T = string>() {} })\n", "(class A {\n  foo() {\n  }\n});\n")
	// expectPrintedTS(t, "declare class A { foo<T = string>(): void }\n", "")
	// expectPrintedTS(t, "<T = string>() => 123\n", "() => 123;\n")

	// // declare_export
	// expectPrintedTS(t, "declare export class A { static : number }\n", "")

	// // declare_export/batch
	// expectPrintedTS(t, "declare export * from \"foo\";\n", "")
	// expectPrintedTS(t, "declare export * from \"foo\"\n", "")

	// // declare_export/class
	// expectPrintedTS(t, "declare export class A {}\n", "")
	// expectPrintedTS(t, "declare export class A<T> extends B<T> { x: number }\n", "")
	// expectPrintedTS(t, "declare export class A { static foo(): number; static x : string }\n", "")
	// expectPrintedTS(t, "declare export class A { static [ indexer: number]: string }\n", "")
	// expectPrintedTS(t, "declare export class A { static () : number }\n", "")

	// // declare_export/function
	// expectPrintedTS(t, "declare export function foo(): void\n", "")
	// expectPrintedTS(t, "declare export function foo(): void;\n", "")
	// expectPrintedTS(t, "declare export function foo<T>(): void;\n", "")
	// expectPrintedTS(t, "declare export function foo(x: number, y: string): void;\n", "")
	// expectPrintedTS(t, "declare export function foo(x: number, string): void\n", "")

	// // declare_export/default
	// expectPrintedTS(t, "declare export default (string);\n", "")
	// expectPrintedTS(t, "declare export default (string)\n", "")
	// expectPrintedTS(t, "declare export default number;\n", "")
	// expectPrintedTS(t, "declare export default number\n", "")
	// expectPrintedTS(t, "declare export default function foo(): void\n", "")
	// expectPrintedTS(t, "declare export default function foo(): void;\n", "")
	// expectPrintedTS(t, "declare export default function foo<T>(): void;\n", "")
	// expectPrintedTS(t, "declare export default function foo(x: number, y: string): void;\n", "")
	// expectPrintedTS(t, "declare export default class A {}\n", "")
	// expectPrintedTS(t, "declare export default class A<T> extends B<T> { x: number }\n", "")
	// expectPrintedTS(t, "declare export default class A { static foo(): number; static x : string }\n", "")
	// expectPrintedTS(t, "declare export default class A { static [ indexer: number]: string }\n", "")
	// expectPrintedTS(t, "declare export default class A { static () : number }\n", "")

	// // declare_export/var
	// expectPrintedTS(t, "declare export var x\n", "")
	// expectPrintedTS(t, "declare export var x;\n", "")
	// expectPrintedTS(t, "declare export var x: number;\n", "")

	// // declare_export/named
	// expectPrintedTS(t, "declare export {} from \"foo\";\n", "")
	// expectPrintedTS(t, "declare export { bar } from \"foo\";\n", "")
	// expectPrintedTS(t, "declare export { bar } from \"foo\"\n", "")
	// expectPrintedTS(t, "declare export { bar, baz } from \"foo\";\n", "")
	// expectPrintedTS(t, "declare export { bar };\n", "")
	// expectPrintedTS(t, "declare export { bar, }\n", "")
	// expectPrintedTS(t, "declare export { bar, baz };\n", "")

	// // declare_export_invalid
	// expectPrintedTS(t, "declare export class A { static implements: number; implements: number }\n", "")

	// // object/indexers
	// expectPrintedTS(t, "type X = { [string: string]: string }\n", "")
	// expectPrintedTS(t, "type X = { [switch: string]: string }\n", "")

	// // object/methods
	// expectPrintedTS(t, "type T = { foo<U>(x: U): number; }\n", "")
	// expectPrintedTS(t, "type T = { foo(): number };\n", "")

	// // opaque_aliases/declare
	// expectPrintedTS(t, "declare export opaque type Foo\n", "")
	// expectPrintedTS(t, "declare export opaque type Foo: Bar\n", "")
	// expectPrintedTS(t, "declare opaque type Foo\n", "")
	// expectPrintedTS(t, "declare opaque type Test: Foo\n", "")

	// // opaque_aliases/valid
	// expectPrintedTS(t, "opaque type Counter: Box<T> = Container<T>;\n", "")
	// expectPrintedTS(t, "export opaque type Counter: Box<T> = Container<S>;\n", "")
	// expectPrintedTS(t, "opaque type FBID = number;\n", "")
	// expectPrintedTS(t, "export opaque type FBID = number;\n", "")
	// expectPrintedTS(t, "opaque type switch = number;\n", "")
}
