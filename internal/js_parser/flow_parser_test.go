...
func TestBasicsFlowTypes(t *testing.T) {
	...
	expectPrintedFlow(t,
		...
		"import { implementationModule } from \"module\";\n")
	expectPrintedFlow(t,
		"import type HttpModule, { HttpConfig } from \"module\"\n",
		"")
	expectPrintedFlow(t,
	...
	expectPrintedFlow(t, "type Obj = { metadata?: { ... } }", "")
	expectPrintedFlow(t,
		"function foo(): Array<*> { return [5]; }\n",
		"function foo() {\n  return [5];\n}\n")
	expectPrintedFlow(t, "type EmptyObject = {}", "")
	expectPrintedFlow(t, "(42: number)", "42;\n")
	// expectPrintedFlow(t, "const expr = action || (42: number)", "const expr = action || 42;\n")
...
func TestBabelFlowTypes(t *testing.T) {
	...
	expectPrintedFlow(t, "a={set fooProp(value:number){}}", "a = { set fooProp(value) {\n} };\n")
	expectPrintedFlow(t, "a={get fooProp():number{}}", "a = { get fooProp() {\n} };\n")
	expectPrintedFlow(t, "a={set fooProp(value:number):void{}}", "a = { set fooProp(value) {\n} };\n")
